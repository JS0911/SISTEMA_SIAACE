<?php
    class Bitacora {
       ...
       public static function EVENT_BITACORA($datosEvento){
            ...
            $ejecutarSQL = "INSERT INTO tbl_ms_bitacora (`fecha`,`accion`, `descripcion`, `id_Usuario`, `id_Objeto`, ) 
            VALUES('$datosEvento->accion','$datosEvento->descripcion','$datosEvento->fecha','$datosEvento->idUsuario','$datosEvento->idObjeto')";
