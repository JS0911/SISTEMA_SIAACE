<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $nuevoUsuario->nombreUsuario = $_POST["nombre"];
        $nuevoUsuario->idestado_usuario= 1; 
        $nuevoUsuario->contrasena = password_hash($_POST["contraseña"], PASSWORD_DEFAULT);
        $nuevoUsuario->correo_electronico = $_POST["correoElectronico"]; 
