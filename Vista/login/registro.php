...
<head>
    ...
    <link href="http://localhost:90/APP_COOPERATIVA_SISTEMAWEB/Recursos/css/registro.css" rel="stylesheet">
    ...
    <div class="ancho">
        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" id="formRegis">
            <div class="logo-empresa">
                <img src="../../Recursos/imagenes/IDH.png" height="200px">
            </div>
            <h2 class ="titulo-registro">Registro Usuario</h2>
